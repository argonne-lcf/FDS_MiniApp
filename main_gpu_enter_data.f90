PROGRAM LOOP3D
! This program is a GPU port of the original Loop3D app
! that uses TARGET ENTER/EXIT DATA along with MAP directives to keep data resident
! on the device during the simulation.
USE OMP_LIB
IMPLICIT NONE
